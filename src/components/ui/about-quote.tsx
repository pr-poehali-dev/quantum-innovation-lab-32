        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Студия «Стиль» — это команда профессионалов в Казани, которые защищают автомобили своих клиентов с 2018 года. Мы работаем только с проверенными материалами и никогда не экономим на качестве.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Каждый автомобиль — это ценность. Мы устанавливаем PPF-плёнку, шумоизоляцию и дополнительное оборудование так, как будто это наш собственный автомобиль. Аккуратно, честно, с гарантией.
            </p>
          </div>
        </div>
      </div>
